        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="printall.php"><i class="fa fa-qrcode"></i> Print Reservation</a>
                    </li>
                    <li>
                        <a  href="profit.php"><i class="fa fa-qrcode"></i> Percentage</a>
                    </li>
                    <li>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                           Booking Details<small> List </small>
                        </h1>
                    </div>
                </div> 
                 <!-- /. ROW  -->
